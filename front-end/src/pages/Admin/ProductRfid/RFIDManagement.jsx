...
const filteredEntries = rfidEntries.filter(entry=>{
  const matchesSearch =
entry.rfidNumber.toLowerCase().includes(searchTerm.toLowerCase())||
...
entry.workplace.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const matchesWorkplace = workplaceFilter === 'All Workplace' || entry.workplace === workplaceFilter;
                ...
                <td className='py-4 px-4'>
                  <div className='flex item-center gap-2'>
                    ...
                    <button
                      ...
                      className='text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 trensition-colors'
