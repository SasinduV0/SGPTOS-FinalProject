...
const EmployeeManagementPage = () => {
  ...
  const [employees, setEmployees] = useState([
    { id: 101, name: 'John Smith', qcUnit: 'Operation A', dateAdded: '2025-01-15', status: 'Active' },
    { id: 102, name: 'Sarah Johnson', qcUnit: 'Operation B', dateAdded: '2025-02-10', status: 'Active' },
    { id: 103, name: 'Mike Wilson', qcUnit: 'Operation C', dateAdded: '2025-01-22', status: 'Active' },
    { id: 104, name: 'Lisa Brown', qcUnit: 'Operation A', dateAdded: '2025-03-05', status: 'Active' },
    { id: 105, name: 'David Lee', qcUnit: 'Operation B', dateAdded: '2025-02-18', status: 'Active' },
    { id: 106, name: 'Emma Davis', qcUnit: 'Operation C', dateAdded: '2025-01-30', status: 'Active' },
    { id: 107, name: 'Tom Anderson', qcUnit: 'Operation A', dateAdded: '2025-03-12', status: 'Active' },
    { id: 108, name: 'Anna White', qcUnit: 'Operation B', dateAdded: '2025-02-25', status: 'Active' }
  ]);
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">Manage QC team members and their assignments</p>
              </div>
